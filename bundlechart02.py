# Jupyter cell version of the bundle plot visualization with dynamic sensor selection
...
if not available_years:
    ...
    if max_profiles == 0:
        ...
        def plot_bundle(sensor1, sensor2, nProfiles, index0, low1, high1, mode1, low2, high2, mode2):
