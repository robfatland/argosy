...
# Adaptive sigma: use median distance
...
print(f"  1. Median distance: {median_distance:.2f}")
print(f"  2. 0.5 × median: {0.5 * median_distance:.2f}")
print(f"  3. 2.0 × median: {2.0 * median_distance:.2f}")
...
if sigma_choice == "1":
    ...
    sigma = 0.5 * median_distance
elif sigma_choice == "3":
    sigma = 2.0 * median_distance
elif sigma_choice == "4":
    sigma = float(input("Enter custom sigma value: "))

print(f"\nUsing sigma = {sigma:.2f}")
...
nx.write_gpickle(G, 'similarity_graph.gpickle')
...
print("\nSaved:")
print("  - similarity_graph.gpickle")
