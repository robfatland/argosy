...
Human-selected MLD from a temperature profile. The data are shown filtered (black trace) and raw (grey trace). This is part of a February 2018 profile at Axial Base.
