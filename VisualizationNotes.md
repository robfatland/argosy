...
This document covers the visualization tools for the argosy project: bundle plots,
curtain plots, animations, and the midnight/noon annotation system.
Code for visualizations resides in `~/argosy/chapters/Visualizations.ipynb`.
